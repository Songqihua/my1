# -*- coding: utf-8 -*-
# Generated by Django 1.11.13 on 2018-07-03 11:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('myadmin', '0013_auto_20180702_1950'),
    ]
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='classify',
            options={'permissions': (('show_cslassify', '查看商品分类管理'), ('insert_cslassify', '添加商品分类'), ('edit_cslassify', '修改商品分类'), ('del_cslassify', '删除商品分类'))},
        ),
        migrations.AlterModelOptions(
            name='goods',
